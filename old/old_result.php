            ...
            <div class="cardContainer">
                <?php
                    /*for ($resRow = 0; $resRow < $queryNumRows; $resRow++) {
                          echo "<div id='card'><div class='cardImage'>".$multiRes[$resRow]['gym_id']."</div>";
                          echo "<div class='cardDetails'><div class='cardTitle'>".$multiRes[$resRow]['gym_name']."   ".round( $multiRes[$resRow]['rating'], 1, PHP_ROUND_HALF_EVEN)." / 5"."</div><div class='cardInfos'>".$multiRes[$resRow]['gym_owner']."   ".$multiRes[$resRow]['gym_location']."   ".$multiRes[$resRow]['gym_description']."</div></div></div>";
                    }
                    echo "</div>";*/
                    ...
                    for ($resRow = 0; $resRow < $queryNumRows; $resRow++) {
                        echo "<div id='card'>";
                        echo "<div class='cardImage'>".$multiRes[$resRow]['gym_id']."</div>";
                        echo "<div class='cardDetails'>";
                        echo "<div class='cardTitle'>".$multiRes[$resRow]['gym_name']."     ".round( $multiRes[$resRow]['rating'], 1, PHP_ROUND_HALF_EVEN)." / 5"."</div>";
                        echo "<div class='cardInfos'>".$multiRes[$resRow]['gym_owner']." ".$multiRes[$resRow]['gym_location']."  ".$multiRes[$resRow]['gym_description']."</div>";
                        echo "</div>";
                        echo "</div>";
                    }*/
                    
                    echo "<p>onclick version</p>";
                    ...
                    for ($resRow = 0; $resRow < $queryNumRows; $resRow++) {
                        echo "<div id='card' onclick=\"location.href='gym-page.php?gym_id=".$multiRes[$resRow]["gym_id"]."'\">";
                            echo "<div class='cardImage' style='background-image:url(".$multiRes[$resRow]["gym_icon"].");'>";
                                /*echo "<img src='sub/goderecci_low.jpg'>";*/
                            echo "</div>";//  .cardImage
